...
CHAIN_KEYS: Dict[str, List[str]] = {
    ...
    "zambrero": ["zambrero"],
    # Orphan chains: data exists in chain_menu_ingested but no alias matcher — add.
    "afc": ["afc", "american fried chicken"],
    "bettys_burgers": ["bettys burgers", "betty's burgers", "bettys burgers and concrete co"],
    "bills": ["bills", "bill's", "bills restaurant", "bill's restaurant"],
    "candies": ["candies", "candies india"],
    "firangi_bake": ["firangi bake", "firangi bake by ovenstory"],
    "haiku": ["haiku", "haiku asian"],
    "haveli": ["haveli"],
    "honest": ["honest", "honest restaurant"],
    "melt": ["melt", "melt bbq", "melt burger"],
    "mixue": ["mixue", "mixue ice cream", "mixue ice cream and tea"],
    "pindi": ["pindi", "pindi restaurant"],
    "presto": ["presto"],
    "pure": ["pure", "pure earth"],
    "dean_and_david": ["dean and david", "dean & david", "dean&david"],
    "moms_touch": ["moms touch", "mom's touch", "momst touch"],
    "paris_baguette": ["paris baguette", "parisbaguette"],
    "vapiano": ["vapiano"],
    ...
    "vapiano": ["vapiano"],
    "natural_ice_cream": ["natural ice cream", "naturals ice cream", "natural's"],
    "rolls_mania": ["rolls mania", "rollsmania"],
    "sagar_gaire": ["sagar gaire"],
    "keventers": ["keventers"],
    "burger_singh": ["burger singh"],
    "wow_china": ["wow china", "wow! china", "wow china by wow momo"],
    "anand_sweets": ["anand sweets", "anand sweets and savouries"],
    "eat_sure": ["eatsure", "eat sure"],
    "instapizza": ["instapizza", "insta pizza"],
    "jumbo_king": ["jumbo king", "jumboking"],
    "a_and_w": ["a&w", "a and w", "a & w"],
    "smashburger": ["smashburger", "smash burger"],
    "white_castle": ["white castle", "whitecastle"],
    "wingstop": ["wingstop", "wing stop"],
    "tim_hortons": ["tim hortons", "tims", "tim horton's"],
    "wagamama": ["wagamama"],
    "wasabi": ["wasabi"],
    ...
    # --- Wave 2 bulk add: single-token chain_keys (≥5 chars, generic words skipped) ---
    "sodabottleopenerwala": ["sodabottleopenerwala"],
    "intelligentsia": ["intelligentsia"],
    "rossopomodoro": ["rossopomodoro"],
    "wetherspoons": ["wetherspoons"],
    "annalakshmi": ["annalakshmi"],
    "dasaprakash": ["dasaprakash"],
    "fuddruckers": ["fuddruckers"],
    "gelatissimo": ["gelatissimo"],
    "ghasitarams": ["ghasitarams"],
    "kebabsville": ["kebabsville"],
    "smashburger": ["smashburger"],
    "tantalizers": ["tantalizers"],
    "burgerfuel": ["burgerfuel"],
    "carluccios": ["carluccios"],
...
def resolve_chain_menu_for_place(
    ...
    *,
    ...
    "absolute_barbecues": ["absolute barbecues", "ab's", "absolute bbq"],
    "al_jawahar": ["al jawahar", "jawahar restaurant"],
    "amritsari_naan": ["amritsari naan", "amritsari kulcha"],
    "anand_restaurant": ["anand restaurant", "anand bhavan"],
    "anda_stall": ["anda stall", "egg stall", "anda wala"],
    "andhra_bhavan": ["andhra bhavan", "andhra mess"],
    "annapoorna": ["annapoorna", "anna poorna"],
    "assamese_kitchen": ["assamese kitchen", "assam kitchen"],
    "belgian_waffle": ["the belgian waffle co", "belgian waffle"],
    "bengali_kitchen": ["bengali kitchen", "bengali restaurant"],
    "bheemas": ["bheema's", "bheemas"],
    "bira_taproom": ["bira 91 taproom", "bira taproom"],
    "biryani_pot": ["biryani pot"],
    "biryani_stall": ["biryani stall", "biryani point"],
    "bombay_canteen": ["the bombay canteen", "bombay canteen"],
    "bowl_company": ["the bowl company", "bowl company"],
    "box_8": ["box8", "box 8"],
    "britto": ["britto's", "brittos goa"],
    "cafe_lota": ["cafe lota"],
    "cafe_madras": ["cafe madras", "madras cafe"],
    "cafe_mondegar": ["cafe mondegar", "mondegar"],
    "cha_cha_chai": ["cha cha chai"],
    "chaat_adda": ["chaat adda"],
    "chaat_street": ["chaat street"],
    "chai_break": ["chai break"],
    "chai_chun": ["chai chun"],
    "chai_garam": ["chai garam"],
    "chai_kings": ["chai kings"],
    "chai_thela": ["chai thela"],
    "chai_wala": ["chai wala", "chaiwala"],
    "chai_wali": ["chai wali"],
    "chettinad": ["chettinad restaurant", "chettinad kitchen"],
    "chicking": ["chicking", "chick king"],
    "chinese_delivery": ["chinese food", "chinese restaurant"],
    "chinese_wok": ["chinese wok", "the chinese wok"],
    "cream_stone": ["cream stone"],
    "darjeeling_food": ["darjeeling restaurant"],
    "daryaganj": ["daryaganj"],
    "dehradun_food": ["dehradun restaurant"],
    "dhaba_franchise": ["dhaba", "punjabi dhaba"],
    "dosa_plaza": ["dosa plaza"],
    "flying_saucer": ["flying saucer cafe"],
    "guwahati_food": ["guwahati restaurant"],
    "hatti_kaapi": ["hatti kaapi", "hatti coffee"],
    "highway_dhaba": ["highway dhaba", "dhaba"],
    "hot_chips": ["hot chips"],
    "hyderabadi_biryani": ["hyderabadi biryani", "hyderabad biryani house"],
    "idli_dosa_stall": ["idli dosa", "south indian stall"],
    "idris_biryani": ["idris biryani"],
    "indian_coffee_house": ["indian coffee house", "coffee house"],
    "jodhpur_food": ["jodhpur restaurant"],
    "jolly_good": ["jolly good"],
    "juice_stall": ["juice stall", "juice wala", "juice centre"],
    "junior_kuppanna": ["junior kuppanna", "kuppanna"],
    "kachori_gali": ["kachori gali"],
    "kathi_junction": ["kathi junction", "kathi roll"],
    "kathiawadi": ["kathiawadi restaurant"],
    "kayees": ["kayees", "kayees rahmathulla"],
    "kesar_da_dhaba": ["kesar da dhaba"],
    "kolkata_biryani": ["kolkata biryani"],
    "konkan": ["konkan restaurant", "konkani food"],
    "kulcha_land": ["kulcha land"],
    "leopold_cafe": ["leopold cafe", "leopold's"],
    "litti_chokha": ["litti chokha"],
    "local_bakery": ["bakery", "cake shop"],
    "lord_of_the_drinks": ["lord of the drinks", "lotd"],
    "machali": ["machali restaurant"],
    "mad_momos": ["mad momos"],
    "madras_cafe": ["madras cafe"],
    "madras_coffee_house": ["madras coffee house"],
    "malabar_junction": ["malabar junction"],
    "malabar_kitchen": ["malabar kitchen"],
    "mandarin_oak": ["mandarin oak"],
    "manek_chowk": ["manek chowk"],
    "mba_chaiwala": ["mba chaiwala", "mba chai wala"],
    "meenakshi_bhavan": ["meenakshi bhavan"],
    "mithai_shop": ["mithai shop", "sweet shop", "halwai"],
    "momos_point": ["momos point"],
    "momos_stall": ["momos stall", "momo wala"],
    "murugan_idli": ["murugan idli shop", "murugan idli"],
    "mylari": ["mylari", "mylari dosa"],
    "mysore_woodlands": ["mysore woodlands"],
    "ne_india_kitchen": ["northeast kitchen", "naga kitchen"],
    "north_indian_delivery": ["north indian", "punjabi food"],
    "odia_kitchen": ["odia kitchen", "odisha food"],
    "ohris": ["ohri's", "ohris"],
    "oye_kiddan": ["oye kiddan"],
    "pal_dhaba": ["pal dhaba"],
    "paranthe_wali_gali": ["paranthe wali gali"],
    "paratha_stall": ["paratha stall", "paratha wala"],
    "peter_cat": ["peter cat"],
    "punjabi_angithi": ["punjabi angithi"],
    "punjabi_chaap": ["chaap corner", "punjabi chaap"],
    "rameshwaram_cafe": ["rameshwaram cafe"],
    "sarafa_bazaar": ["sarafa bazaar"],
    "sharief_bhai": ["sharief bhai"],
    "shimla_food": ["shimla restaurant"],
    "sikkim_food": ["sikkim restaurant"],
    "south_indian_delivery": ["south indian", "south indian restaurant"],
    "street_samosa": ["samosa shop", "samosa stall"],
    "subbayya": ["subbayya hotel", "subbayya gari"],
    "surati_food": ["surati restaurant"],
    "swiggy_biryani": ["biryani shop", "biryani wala"],
    "tamil_street": ["tamil street food"],
    "tapri": ["tapri", "tapri chai"],
    "tarri_poha": ["tarri poha"],
    "telangana_kitchen": ["telangana kitchen"],
    "thalappakatti": ["thalappakatti", "dindigul thalappakatti"],
    "thalassery": ["thalassery restaurant"],
    "thela_food": ["thela", "cart food", "street cart"],
    "tiffin_service": ["tiffin service", "dabba wala"],
    "tossin_pizza": ["tossin pizza"],
    "trivandrum_food": ["trivandrum restaurant"],
    "tunday_kababi": ["tunday kababi", "tunday kebab"],
    "udaipur_food": ["udaipur restaurant"],
    "udupi": ["udupi restaurant", "udupi hotel"],
    "under_the_mango_tree": ["under the mango tree"],
    "vidyarthi_bhavan": ["vidyarthi bhavan"],
    "vohuman_cafe": ["vohuman cafe"],
    "wazwan": ["wazwan", "kashmiri restaurant"],
    "wok_express": ["wok express"],
    "wok_n_roll": ["wok n roll"],
    "wok_this_way": ["wok this way"],
    "yo_china": ["yo china"],
}
